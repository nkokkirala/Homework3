const N_Token = artifacts.require("./N_Token.sol");
const N_Crowdsale = artifacts.require("./N_Crowdsale.sol");
...
module.exports = async function(deployer, network, accounts) {
  ...
  await deployer.deploy(N_Token, _name, _symbol, _decimals);
  const deployedToken = await N_Token.deployed();
